...
INSERT INTO files (file_name, app_id, channel_id) VALUES
    ('UserMicroservice.dev.1.0.tar', '9a76fdbe-3f7c-4a59-8fa5-09e7f8c8e7d1', 1),
    ('UserMicroservice.QA.1.1.tar', '9a76fdbe-3f7c-4a59-8fa5-09e7f8c8e7d1', 2),
    ('UserMicroservice.prod.2.0.tar', '9a76fdbe-3f7c-4a59-8fa5-09e7f8c8e7d1', 3),
    ('UserMicroservice.stress.2.1.tar', '9a76fdbe-3f7c-4a59-8fa5-09e7f8c8e7d1', 4),
    ('UserMicroservice.PR.3.0.tar', '9a76fdbe-3f7c-4a59-8fa5-09e7f8c8e7d1', 5),

    ('PaymentMicroservice.dev.1.0.tar', '7ec9d29f-8b13-4d2c-b729-7f6893e2b4ab', 6),
    ('PaymentMicroservice.QA.1.1.tar', '7ec9d29f-8b13-4d2c-b729-7f6893e2b4ab', 7),
    ('PaymentMicroservice.prod.2.0.tar', '7ec9d29f-8b13-4d2c-b729-7f6893e2b4ab', 8),
    ('PaymentMicroservice.stress.2.1.tar', '7ec9d29f-8b13-4d2c-b729-7f6893e2b4ab', 9),
    ('PaymentMicroservice.PR.3.0.tar', '7ec9d29f-8b13-4d2c-b729-7f6893e2b4ab', 10),

    ('OrderMicroservice.dev.1.0.tar', '4f29e3e1-6e02-44ec-a244-9aa18d1c2955', 11),
    ('OrderMicroservice.QA.1.1.tar', '4f29e3e1-6e02-44ec-a244-9aa18d1c2955', 12),
    ('OrderMicroservice.prod.2.0.tar', '4f29e3e1-6e02-44ec-a244-9aa18d1c2955', 13),
    ('OrderMicroservice.stress.2.1.tar', '4f29e3e1-6e02-44ec-a244-9aa18d1c2955', 14),
    ('OrderMicroservice.PR.3.0.tar', '4f29e3e1-6e02-44ec-a244-9aa18d1c2955', 15),

    ('InventoryMicroservice.dev.1.0.tar', 'f4d508d9-8520-4652-98f2-13cbb5a58625', 16),
    ('InventoryMicroservice.QA.1.1.tar', 'f4d508d9-8520-4652-98f2-13cbb5a58625', 17),
    ('InventoryMicroservice.prod.2.0.tar', 'f4d508d9-8520-4652-98f2-13cbb5a58625', 18),
    ('InventoryMicroservice.stress.2.1.tar', 'f4d508d9-8520-4652-98f2-13cbb5a58625', 19),
    ('InventoryMicroservice.PR.3.0.tar', 'f4d508d9-8520-4652-98f2-13cbb5a58625', 20),

    ('NotificationMicroservice.dev.1.0.tar', '1f38cb34-119c-4b7e-9d27-3988bf55f51a', 21),
    ('NotificationMicroservice.QA.1.1.tar', '1f38cb34-119c-4b7e-9d27-3988bf55f51a', 22),
    ('NotificationMicroservice.prod.2.0.tar', '1f38cb34-119c-4b7e-9d27-3988bf55f51a', 23),
    ('NotificationMicroservice.stress.2.1.tar', '1f38cb34-119c-4b7e-9d27-3988bf55f51a', 24),
    ('NotificationMicroservice.PR.3.0.tar', '1f38cb34-119c-4b7e-9d27-3988bf55f51a', 25),
    ...
    ('ShippingService.dev.1.0.tar', '76c2ee75-dbc6-4e2e-8584-8112a43f91a6', 81),
    ('ShippingService.QA.1.1.tar', '76c2ee75-dbc6-4e2e-8584-8112a43f91a6', 82),
    ('ShippingService.prod.2.0.tar', '76c2ee75-dbc6-4e2e-8584-8112a43f91a6', 83),
    ('ShippingService.stress.2.1.tar', '76c2ee75-dbc6-4e2e-8584-8112a43f91a6', 84),
    ('ShippingService.PR.3.0.tar', '76c2ee75-dbc6-4e2e-8584-8112a43f91a6', 85),

    ('RecommendationEngineService.dev.1.0.tar', 'dab62d33-82da-4ab2-a1f2-168d1e85efb1', 86),
    ('RecommendationEngineService.QA.1.1.tar', 'dab62d33-82da-4ab2-a1f2-168d1e85efb1', 87),
    ('RecommendationEngineService.prod.2.0.tar', 'dab62d33-82da-4ab2-a1f2-168d1e85efb1', 88),
    ('RecommendationEngineService.stress.2.1.tar', 'dab62d33-82da-4ab2-a1f2-168d1e85efb1', 89),
    ('RecommendationEngineService.PR.3.0.tar', 'dab62d33-82da-4ab2-a1f2-168d1e85efb1', 90);